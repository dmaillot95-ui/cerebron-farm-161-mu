...
class T(unittest.TestCase):
 def test_arch(self):
  a=json.loads((ROOT/"architecture"/"MU_ARCHITECTURE_V1.json").read_text());self.assertFalse(a["runtime_changed"]);self.assertEqual(a["campaign"]["passes"],10);self.assertEqual(a["role_id"],"UNCERTAINTY_QUANTIFIER")
